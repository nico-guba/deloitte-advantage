...
class ZoneResourceTest implements EqualityVerifier<ZoneResource> {
    ...
    public static final String ZONE_AS_JSON = "{\"id\":\"359dfe3f-aaad-461c-87a7-08d9368584f1\",\"facilities\":[]}";
    ...
    @Test
    void toStringTest() {
        assertEquals("ZoneResource[id=359dfe3f-aaad-461c-87a7-08d9368584f1, facilities=[]]",
                actual.toString());
    }
